    ...
    async def on_message(message: aio_pika.IncomingMessage):
        async with message.process():
            ...
            try:
                ...
                print(f"[lp-detector] File not found: {image_path}")
                return
            ...
            if licenceplate:
                ...
                print(f"[lp-detector] Detected {licenceplate} in {filename}")
            else:
                print(f"[lp-detector] No licence plate in {filename}")

    await queue.consume(on_message)
    print("[lp-detector] Consuming picture.created events")
