...
class Settings(BaseSettings):
    ...
    service_name: str = "licenceplate-validator"
    service_url: str = "http://licenceplate-validator:8015"
    database_url: str = "sqlite+aiosqlite:////app/data/licenceplate.db"
    ...
    try:
        async with httpx.AsyncClient(timeout=10.0) as client:
            ...
            if resp.status_code == 200:
                data = resp.json()
                settings.database_url = data.get("database_url", settings.database_url)
