...
Likwidator szkody komunikacyjnej (użytkownik systemu) chcę móc przesłać do aplikacji zdjęcia pojazdu żeby otrzymać informacje z systemu na temat numeru rejestracyjnego pojazdu i numeru identyfikacyjnego pojazdu (VIN).
